...
def draw_tree(x, y):
	...
	glVertex2f(x + 24, y)
	glEnd()
	draw_circle(x + 12, y + 140, 100, 50, 0.273, 0.453, 0.03, 1, 0.15, 0.3, 0, 1)
	draw_circle(x + 36, y + 140, 100, 35, 0.273, 0.453, 0.03, 1, 0.15, 0.3, 0, 1)
	draw_circle(x - 12, y + 140, 100, 35, 0.273, 0.453, 0.03, 1, 0.15, 0.3, 0, 1)
